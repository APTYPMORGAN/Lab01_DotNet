...
Console.WriteLine("Автор: Куриев Артур");
...
Console.WriteLine($"Частное: {num1 / num2}"); else
...
Console.Write("{0}\n{1}\n{2}\n{3}\n",MyFavoriteGame,MyFavoriteNumber,PI,MyFavoriteLetter);
Console.WriteLine("I");
...
double grad_C = double.Parse(Console.ReadLine());
double grad_F = grad_C * 1.8 + 32;
Console.WriteLine($"Температура в Фаренгейтах: {grad_F}");